...
var RegisterHtmlTemplate = __webpack_require__(19);

RegisterHtmlTemplate.register("<dom-module id=webpack-loader-trial> <template> <style>:host{display:block}</style> <h2>Hello [[prop1]], this is such awesome!</h2> </template> </dom-module>");

/**
 * `webpack-loader-trial`
 * 
 *
 * @customElement
 * @polymer
...
var WebpackLoaderTrial = function (_Polymer$Element) {
  _inherits(WebpackLoaderTrial, _Polymer$Element);

  function WebpackLoaderTrial() {
    _classCallCheck(this, WebpackLoaderTrial);

    return _possibleConstructorReturn(this, (WebpackLoaderTrial.__proto__ || Object.getPrototypeOf(WebpackLoaderTrial)).apply(this, arguments));
  }

  _createClass(WebpackLoaderTrial, null, [{
    key: 'is',
    get: function get() {
      return 'webpack-loader-trial';
    }
  }, {
    key: 'properties',
    get: function get() {
      return {
        prop1: {
          type: String,
          value: 'webpack-loader-trial'
        }
      };
    }
  }]);

  return WebpackLoaderTrial;
}(Polymer.Element);

window.customElements.define(WebpackLoaderTrial.is, WebpackLoaderTrial);
