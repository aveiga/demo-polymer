...
RegisterHtmlTemplate.register("<dom-module id=my-element> <template> <style>:host{display:block}</style> <h2>Hello [[prop1]], this is such awesome!</h2> </template> </dom-module>");
...
var MyElement = function (_Polymer$Element) {
  _inherits(MyElement, _Polymer$Element);
